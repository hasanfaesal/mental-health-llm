...
def train():
    ...
    training_args = TrainingConfigs(output_dir=model_args.model_name_or_path.split("/")[-1] + "-finetuned")
    ...
    dataset = dataset.map(lambda x: format_mental_health_data(x, tokenizer), batched=True)
